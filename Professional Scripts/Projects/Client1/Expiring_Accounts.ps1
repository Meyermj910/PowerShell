#This Script is to create a report showing the upcoming accounts to expire within the next 20 days & generate an email and attach a copy of the report to send it to the Service Desk
...
Search-ADAccount -Server domain.com -AccountExpiring -TimeSpan 20.00:00:00 | 
...
$Options = @{
    ...
    'To' = "director@domain.com","me@domain.com"
